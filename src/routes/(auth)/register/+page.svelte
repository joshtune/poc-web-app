<script lang="ts">
	...
	const isAnySocialAuthEnabled = isGoogleAuthEnabled || isFacebookAuthEnabled;
				...
				{#if isAnySocialAuthEnabled}
					<div class="mt-6">
						...
						<div
							...
							class:grid-cols-2={isGoogleAuthEnabled && isFacebookAuthEnabled}
							class:grid-cols-1={isGoogleAuthEnabled !== isFacebookAuthEnabled}
						>
							{#if isGoogleAuthEnabled}
								<Button
									color="light"
